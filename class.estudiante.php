...
/*  $valor="SELECT pac_id FROM pacade ORDER BY pac_fin DESC";
  ...
  $dias=time();
  $fecha=date("Y-m-d H:i:s",$dias);
  $sql="SELECT A.pac_id AS pac_id, count(A.pac_id) AS conteo, A.pac_int AS pac_int FROM pacade A, detins B, matric C, asigna D WHERE A.pac_sta='1' AND det_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND C.ci='$ci' AND C.matr_tip='0' AND C.ci=B.ci_est AND B.mod_id=C.mod_id AND B.reg_id=C.reg_id AND B.esp_id=C.esp_id AND B.coh_id=C.coh_id AND B.pen_top=C.pen_top AND B.asi_cod=D.asi_cod AND  B.mod_id=D.mod_id AND B.reg_id=D.reg_id AND B.esp_id=D.esp_id AND B.coh_id=D.coh_id AND B.pen_top=D.pen_top AND asi_sta='1' AND A.pac_id NOT IN (SELECT pac_id FROM pacade WHERE pac_sta='1' AND DATEDIFF(pac_ffin,'$fecha')>=0) AND B.mod_id='$mod_id' AND B.reg_id='$reg_id' AND B.esp_id='$esp_id' AND B.coh_id='$coh_id' AND B.pen_top='$pen_top' GROUP BY A.pac_id ORDER BY A.pac_fin, D.asi_mod, D.asi_nom";
...
/*  $valor="SELECT pac_id FROM pacade ORDER BY pac_fin DESC";
  ...
  $dias=time();
  $fecha=date("Y-m-d H:i:s",$dias);
  $sql="SELECT A.pac_id AS pac_id, B.asi_cod AS asi_cod, A.pac_int AS pac_int FROM pacade A, detins B, matric C, asigna D WHERE A.pac_sta='1' AND det_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND C.ci='$ci' AND C.matr_tip='0' AND C.ci=B.ci_est AND B.mod_id=C.mod_id AND B.reg_id=C.reg_id AND B.esp_id=C.esp_id AND B.coh_id=C.coh_id AND B.pen_top=C.pen_top AND B.asi_cod=D.asi_cod AND A.pac_id='$pac_id_buscar' AND  B.mod_id=D.mod_id AND B.reg_id=D.reg_id AND B.esp_id=D.esp_id AND B.coh_id=D.coh_id AND B.pen_top=D.pen_top AND asi_sta='1' AND A.pac_id NOT IN (SELECT pac_id FROM pacade WHERE pac_sta='1' AND DATEDIFF(pac_ffin,'$fecha')>=0) AND B.mod_id='$mod_id' AND B.reg_id='$reg_id' AND B.esp_id='$esp_id' AND B.coh_id='$coh_id' AND B.pen_top='$pen_top' GROUP BY A.pac_id, B.pac_id ORDER BY A.pac_fin, D.asi_mod, D.asi_nom";
  $conteo_record=mysql_query($sql,$this->conexion);  
...
//******************************************************************
  ...
  $ext_ult_pac_id=mysql_fetch_object($ult_pac_id);
  $pac_id=$ext_ult_pac_id->pac_id;
  $sql="SELECT A.pac_id FROM pacade A, detins B, matric C, asigna D WHERE A.pac_sta='1' AND det_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND C.ci='$ci' AND C.matr_tip='0' AND C.ci=B.ci_est AND B.mod_id=C.mod_id AND B.reg_id=C.reg_id AND B.esp_id=C.esp_id AND B.coh_id=C.coh_id AND B.pen_top=C.pen_top AND B.asi_cod=D.asi_cod AND  B.mod_id=D.mod_id AND B.reg_id=D.reg_id AND B.esp_id=D.esp_id AND B.coh_id=D.coh_id AND B.pen_top=D.pen_top AND asi_sta='1' AND A.pac_id NOT IN ('$pac_id') AND B.mod_id='$mod_id' AND B.reg_id='$reg_id' AND B.esp_id='$esp_id' AND B.coh_id='$coh_id' AND B.pen_top='$pen_top' GROUP BY A.pac_id ORDER BY A.pac_fin DESC";
...
//******************************************************************   
  ...
  $ext_ult_pac_id=mysql_fetch_object($ult_pac_id);
  $pac_id=$ext_ult_pac_id->pac_id;
  $sql="SELECT A.pac_id AS pac_id, B.asi_cod AS asi_cod FROM pacade A, detins B, matric C, asigna D WHERE A.pac_sta='1' AND det_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND C.ci='$ci' AND C.matr_tip='0' AND C.ci=B.ci_est AND B.mod_id=C.mod_id AND B.reg_id=C.reg_id AND B.esp_id=C.esp_id AND B.coh_id=C.coh_id AND B.pen_top=C.pen_top AND B.asi_cod=D.asi_cod AND B.mod_id=D.mod_id AND B.reg_id=D.reg_id AND B.esp_id=D.esp_id AND B.coh_id=D.coh_id AND B.pen_top=D.pen_top AND asi_sta='1' AND A.pac_id NOT IN ('$pac_id') AND B.obs_id='4' AND B.mod_id='$mod_id' AND B.reg_id='$reg_id' AND B.esp_id='$esp_id' AND B.coh_id='$coh_id' AND B.pen_top='$pen_top' GROUP BY A.pac_id, B.asi_cod ORDER BY A.pac_fin, D.asi_mod, D.asi_nom";
...
//******************************************************************
  function infrae($nuc_id){
    if($nuc_id!="todos")
	  ...
	  $nuc_id="";
	$sql="SELECT A.inf_id, A.inf_nom FROM infrae A, nucleo B WHERE A.inf_sta='1' AND A.nuc_id=B.nuc_id AND B.nuc_sta='1' ".$nucleo." GROUP BY A.inf_id ORDER BY A.inf_nom";
      $resul=mysql_query($sql,$this->conexion);
    ...
    /*if($nuc_id!="todos"){$sql="SELECT A.inf_id, A.inf_nom FROM infrae A, nucleo B WHERE A.inf_sta='1' AND A.nuc_id=B.nuc_id AND B.nuc_sta='1' AND B.nuc_id='$nuc_id' GROUP BY A.inf_id ORDER BY A.inf_nom";$resul=mysql_query($sql,$this->conexion);    while($array=mysql_fetch_object($resul)){if($id==""){$id=$array->inf_id;
	$des=$array->inf_nom;}else{$id=$id."*".$array->inf_id;      $des=$des."*".$array->inf_nom;}$cuantos++;}$this->res=$id."@".$des."@".$cuantos;}
	else{$sql="SELECT A.inf_id, A.inf_nom FROM infrae A, nucleo B WHERE A.inf_sta='1' AND A.nuc_id=B.nuc_id AND B.nuc_sta='1' GROUP BY A.inf_id ORDER BY A.inf_nom";$resul=mysql_query($sql,$this->conexion);while($array=mysql_fetch_object($resul)){if($id==""){$id=$array->inf_id;$des=$array->inf_nom;}else{$id=$id."*".$array->inf_id;$des=$des."*".$array->inf_nom;}$cuantos++;}$this->res=$id."@".$des."@".$cuantos;}*/
  }
//******************************************************************
...
//******************************************************************
  ...
  $valor1=explode("*",$valor);//nuc_id*inf_id
	...
	if($valor1[1]!="todos")
	  ...
	  $infrae="";
	$sql="SELECT A.pac_id AS pac_id, A.pac_nom AS pac_nom FROM pacade A, detins B, seccio C, infrae D WHERE A.pac_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta='1' AND B.sec_id=C.sec_id AND C.sec_sta='1' AND C.inf_id=D.inf_id AND D.inf_sta='1' ".$infrae." ".$nucleo." GROUP BY A.pac_id ORDER BY A.pac_fin";
      $resul=mysql_query($sql,$this->conexion);
      while($array=mysql_fetch_object($resul)){
	    if($id==""){
	      $id=$array->pac_id;
...
//******************************************************************
  function Buscar_regimen($valor){
	...
	if($valor1[3]!="todos")
	  ...
	  $modalidad="";
    //if($valor1[0]!="todos" && $valor1[1]!="todos" && $valor1[2]!="todos"){
    $sql="SELECT F.reg_id AS reg_id, F.reg_nom AS reg_nom FROM pacade A, detins B, seccio C, infrae D, modali E, regimen F WHERE A.pac_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta='1' AND B.sec_id=C.sec_id AND C.sec_sta='1' AND C.inf_id=D.inf_id AND inf_sta='1' ".$infrae." ".$nucleo." ".$periodo." ".$modalidad." AND B.mod_id=E.mod_id AND E.mod_sta='1' AND B.reg_id=F.reg_id AND F.reg_sta='1' GROUP BY F.reg_id ORDER BY F.reg_nom";
	/*echo "<script>alert('SELECT F.reg_id AS reg_id, F.reg_nom AS reg_nom FROM pacade A, detins B, seccio C, infrae D, modali E, regimen F WHERE A.pac_sta=1 AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta=1 AND B.sec_id=C.sec_id AND C.sec_sta=1 AND C.inf_id=D.inf_id AND inf_sta=1 $infrae $nucleo $periodo $modalidad AND B.mod_id=E.mod_id AND E.mod_sta=1 AND B.reg_id=F.reg_id AND F.reg_sta=1 GROUP BY F.reg_id ORDER BY F.reg_nom')</script>";*/
    $resul=mysql_query($sql,$this->conexion);
    while($array=mysql_fetch_object($resul)){
	  if($id==""){
	    $id=$array->reg_id;
...
//******************************************************************
  function Buscar_carrera($valor){
	...
	if($valor1[4]!="todos")
	  ...
	  $regimen="";
    //if($valor1[0]!="todos" && $valor1[1]!="todos" && $valor1[2]!="todos"){
    $sql="SELECT G.esp_id AS esp_id, G.esp_nom AS esp_nom FROM pacade A, detins B, seccio C, infrae D, modali E, regimen F, especi G WHERE A.pac_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta='1' AND B.sec_id=C.sec_id AND C.sec_sta='1' AND C.inf_id=D.inf_id AND inf_sta='1' ".$infrae." ".$nucleo." ".$periodo." ".$modalidad." ".$regimen." AND B.mod_id=E.mod_id AND E.mod_sta='1' AND B.reg_id=F.reg_id AND F.reg_sta='1' AND B.esp_id=G.esp_id AND G.esp_sta='1' GROUP BY G.esp_nom ORDER BY G.esp_nom";
	/*echo "<script>alert('SELECT G.esp_id AS esp_id, G.esp_nom AS esp_nom FROM pacade A, detins B, seccio C, infrae D, modali E, regimen F, especi G WHERE A.pac_sta=1 AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta=1 AND B.sec_id=C.sec_id AND C.sec_sta=1 AND C.inf_id=D.inf_id AND inf_sta=1 $infrae $nucleo $periodo $modalidad $regimen AND B.mod_id=E.mod_id AND E.mod_sta=1 AND B.reg_id=F.reg_id AND F.reg_sta=1 AND B.esp_id=G.esp_id AND G.esp_sta=1 GROUP BY G.esp_id ORDER BY G.esp_nom')</script>";*/
    $resul=mysql_query($sql,$this->conexion);
    while($array=mysql_fetch_object($resul)){
	  if($id==""){
	    $id=$array->esp_id;
...
//******************************************************************
  function Buscar_pensum($valor){
	...
	if($valor1[5]!="todos")
	  ...
	  $carrera="";
    //if($valor1[0]!="todos" && $valor1[1]!="todos" && $valor1[2]!="todos"){
    $sql="SELECT H.coh_id AS coh_id, H.coh_nom AS coh_nom FROM pacade A, detins B, seccio C, infrae D, modali E, regimen F, especi G, cohort H WHERE A.pac_sta='1' AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta='1' AND B.sec_id=C.sec_id AND C.sec_sta='1' AND C.inf_id=D.inf_id AND inf_sta='1' ".$infrae." ".$nucleo." ".$periodo." ".$modalidad." ".$regimen." ".$carrera." AND B.mod_id=E.mod_id AND E.mod_sta='1' AND B.reg_id=F.reg_id AND F.reg_sta='1' AND B.esp_id=G.esp_id AND G.esp_sta='1' AND B.coh_id=H.coh_id AND H.coh_sta='1' GROUP BY H.coh_id ORDER BY H.coh_nom";
	/*echo "<script>alert('SELECT H.coh_id AS coh_id, H.coh_nom AS coh_nom FROM pacade A, detins B, seccio C, infrae D, modali E, regimen F, especi G, cohort H WHERE A.pac_sta=1 AND A.pac_id=B.pac_id AND A.mod_id=B.mod_id AND B.det_sta=1 AND B.sec_id=C.sec_id AND C.sec_sta=1 AND C.inf_id=D.inf_id AND inf_sta=1 $infrae $nucleo $periodo $modalidad $regimen $carrera AND B.mod_id=E.mod_id AND E.mod_sta=1 AND B.reg_id=F.reg_id AND F.reg_sta=1 AND B.esp_id=G.esp_id AND G.esp_sta=1 AND B.coh_id=H.coh_id AND H.coh_sta=1 GROUP BY H.coh_id ORDER BY H.coh_nom')</script>";*/
    $resul=mysql_query($sql,$this->conexion);
    while($array=mysql_fetch_object($resul)){
	  if($id==""){
	    $id=$array->coh_id;
...
//******************************************************************
function pacade_equivalencias($ci_est){
	$sql="SELECT DISTINCT(A.pac_id) AS 'pac_id', B.pac_fin AS pac_fin FROM detins A, pacade B, matric C  WHERE A.pac_id=B.pac_id AND A.ci_est='$ci_est' AND A.ci_est=C.ci AND A.esp_id=C.esp_id AND A.mod_id=C.mod_id AND A.reg_id=C.reg_id AND A.coh_id=C.coh_id AND A.pen_top=C.pen_top AND C.matr_sta='1' AND B.pac_sta='1' AND A.det_sta='1' ORDER BY B.pac_fin";
	$resul=mysql_query($sql,$this->conexion);
	$array=mysql_fetch_object($resul);
