...
/*    if($ci=='23547088' || $ci=='19541259' || $ci=='19541259' || $ci=='08332549' || $ci=='20899390' || $ci=='20367999' || $ci=='19541667'){*/
      $resp_pac=$this->OperacionCualquiera("SELECT A.pac_id AS 'pac_id', A.pac_nom AS 'pac_nom', A.pac_int AS 'pac_int', B.ins_nom AS 'ins_nom' FROM pacade A, inscri B WHERE B.ins_sta='1' AND TIMEDIFF('$FECHA',B.ins_fin)>=0 AND TIMEDIFF(B.ins_ffi,'$FECHA')>=0 AND A.pac_id=B.pac_id AND A.pac_sta='1' ORDER BY B.ins_ffi DESC");
/*    }
	else{
      $resp_pac=$this->OperacionCualquiera("SELECT A.pac_id AS 'pac_id', A.pac_nom AS 'pac_nom', A.pac_int AS 'pac_int', B.ins_nom AS 'ins_nom' FROM pacade A, inscri B WHERE B.ins_sta='1' AND TIMEDIFF('$FECHA',B.ins_fin)>=0 AND TIMEDIFF(B.ins_ffi,'$FECHA')>=0 AND A.pac_id=B.pac_id AND A.pac_sta='1' ORDER BY B.ins_ffi ASC");
    }*/
...
/*echo "<script>alert('ENTRE');</script>";*/
	  ...
	  $pac_int=$PAC->pac_int;
	  $Ins_Int_Act=0;
/*	  echo "<script>alert('SELECT * FROM detins WHERE pac_id=I-12012 AND ci_est=$ci and det_sta=1');</script>";*/
//---------------------------------INICIO
//SENTENCIA PARA QUE NO SE INSCRIBAN LOS QUE ESTAN EN EL INTENSIVO
/*	  $resp_pac_Inte=$this->OperacionCualquiera("SELECT * FROM detins WHERE pac_id='I-12012' AND ci_est='$ci' and det_sta='1'");
	  $Ins_Int_Act=$this->NumFilasCualquiera($resp_pac_Inte);*/
//---------------------------------FIN
/*	  echo "<script>alert('REALIZO INTENSIVO $Ins_Int_Act');</script>";*/
	  if($Ins_Int_Act!=0){
...
/*echo "<script>alert('semestre: $pac_nom[0], $pac_int==1 && $DET->ci_est==');</script>";*/
	...
	while($array=$this->ConsultarCualquiera($res)){
	  if($array->tab_id=='27' && ($array->ope_id=='2' || $array->ope_id=='3') && ($PAC->pac_id!="")){// && ($ci=='23547088' || $ci=='19541259' || $ci=='19541259' || $ci=='08332549' || $ci=='20899390' || $ci=='20367999' || $ci=='19541667')){// && ($ci=='19541667' || $ci=='23547088' || $ci=='19541259' || $ci=='08332549'  || $ci=='20899390'  || $ci=='20423818' || $ci=='20367999' || $ci=='19541667')){//){
	     if($pac_int=="1" && $DET->ci_est==''){ /*echo "<script>alert('bandInsI=$bandInsI');</script>";*/ $bandInsI=1; } else{ if($DET->ci_est=="" && $Ins_Int_Act==0) $bandIns=1;}
	  }
	  if($array->tab_id=='36' && ($array->ope_id=='1' || $array->ope_id=='2'  || $array->ope_id=='6'  || $array->ope_id=='7')){ // || $ci=='23547088' || $ci=='21179293' || $ci=='19541259' || $ci=='5643957'  || $ci=='20899390'  || $ci=='20423818')){ //
	    if($DET->ci_est!=""){ $bandpins=1; $bandcones=1; $_SESSION[pac_id]=$pac_id; if($ci=='18791178') $bandsoli=1;} $bandconot=1; $bandconcal=1; $bandracad=1;
	  }
	}
    ...
    $this->resultado="
      ...
      <td width=\"108px\" height=\"25px\"><div id=\"Layer2\" style=\"position:absolute; width:108px; height:20px; z-index:2; top: 0px; left:".$Centro."px;\" class=\"div1Dentro\" onMouseOver=\"CambiarFondo('Layer2','Layer21','Layer22','1','1')\" onMouseOut=\"CambiarFondo('Layer2','Layer21','Layer22','0','1')\" onClick=\"MostrarOcultar_SubMen('Layer23','1','imagestudiante')\">
		...
		if($bandIns==1){ //Inscripcion
			...
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordest_izq216\" style=\"position:absolute; width:4px; height:15px; z-index:216; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Estudiante216\" style=\"position:absolute; z-index:216; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Estudiante216','bordest_izq216','bordest_der216','1','0')\" onMouseOut=\"CambiarFondo('Estudiante216','bordest_izq216','bordest_der216','0','0')\" onClick=\"Opciones_SubMen('../Estudiante/InstruccionesInscripcion.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Inscripción ".$pac_nom[0]."</span></div><div id=\"bordest_der216\" style=\"position:absolute; width:4px; height:15px; z-index:216; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
            $top=$top+15;
        }	
	    ...
	    if($bandracad==1)//Record Academico, Pensum y Planilla de Reingreso
		{
		    $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordest_izq2110\" style=\"position:absolute; width:4px; height:15px; z-index:2110; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Estudiante2110\" style=\"position:absolute; z-index:2110; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Estudiante2110','bordest_izq2110','bordest_der2110','1','0')\" onMouseOut=\"CambiarFondo('Estudiante2110','bordest_izq2110','bordest_der2110','0','0')\" onClick=\"Opciones_SubMen('../Estudiante/Pensum_Est.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Plan de Estudio</span></div><div id=\"bordcord_der2110\" style=\"position:absolute; width:4px; height:15px; z-index:2110; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordest_izq220\" style=\"position:absolute; width:4px; height:15px; z-index:220; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Estudiante220\" style=\"position:absolute; z-index:220; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Estudiante220','bordest_izq220','bordest_der220','1','0')\" onMouseOut=\"CambiarFondo('Estudiante220','bordest_izq220','bordest_der220','0','0')\" onClick=\"Opciones_SubMen('../Planillas/PLANILLA_REINGRESO.pdf','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Planilla Reingreso</span></div><div id=\"bordcord_der220\" style=\"position:absolute; width:4px; height:15px; z-index:220; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordest_izq218\" style=\"position:absolute; width:4px; height:15px; z-index:218; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Estudiante218\" style=\"position:absolute; z-index:218; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Estudiante218','bordest_izq218','bordest_der218','1','0')\" onMouseOut=\"CambiarFondo('Estudiante218','bordest_izq218','bordest_der218','0','0')\" onClick=\"Opciones_SubMen('../Estudiante/ConstanciaRecordAcademico_Est.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Record Acad&eacute;mico</span></div><div id=\"bordcord_der218\" style=\"position:absolute; width:4px; height:15px; z-index:218; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
		if($bandsoli==1)//solicitudes
		{
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordest_izq219\" style=\"position:absolute; width:4px; height:15px; z-index:219; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Estudiante219\" style=\"position:absolute; z-index:219; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Estudiante219','bordest_izq219','bordest_der219','1','0')\" onMouseOut=\"CambiarFondo('Estudiante219','bordest_izq219','bordest_der219','0','0')\" onClick=\"Opciones_SubMen('../Estudiante/Solicitud_Est.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Solicitudes</span></div><div id=\"bordcord_der219\" style=\"position:absolute; width:4px; height:15px; z-index:219; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
...
/*	  if($array->tab_id=='74' && ($idper=='1' || $idper=='3') && ($array->ope_id=='1'|| $array->ope_id=='2' ||$array->ope_id=='3' || $array->ope_id=='4' || $array->ope_id=='5' || $array->ope_id=='6')) $banddispon=1;*/
    ...
    $this->resultado="
	  ...
	  if($banddetins==1){ //Acta de Asistencia
        if($_SESSION[ci]=='17057572'){
            $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq312\" style=\"position:absolute; width:4px; height:15px; z-index:312; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente312\" style=\"position:absolute; z-index:312; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente312','borddoc_izq312','borddoc_der312','1','0')\" onMouseOut=\"CambiarFondo('Docente312','borddoc_izq312','borddoc_der312','0','0')\" onClick=\"Opciones_SubMen('../Doc/ActaAsistencia.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Acta de Asisten Vie</span></div><div id=\"borddoc_der312\" style=\"position:absolute; width:4px; height:15px; z-index:312; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
            $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq3110\" style=\"position:absolute; width:4px; height:15px; z-index:3110; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente3110\" style=\"position:absolute; z-index:3110; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente3110','borddoc_izq3110','borddoc_der3110','1','0')\" onMouseOut=\"CambiarFondo('Docente3110','borddoc_izq3110','borddoc_der3110','0','0')\" onClick=\"Opciones_SubMen('../Doc/ActaAsistencia_Nueva.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Acta de Asistencia</span></div><div id=\"borddoc_der3110\" style=\"position:absolute; width:4px; height:15px; z-index:3110; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
          }
		  ...
		  if($bandinas==1){ //Inasistencias
		    if($_SESSION[ci]=='17057572'){
              $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq319\" style=\"position:absolute; width:4px; height:15px; z-index:319; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente319\" style=\"position:absolute; z-index:319; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente319','borddoc_izq319','borddoc_der319','1','0')\" onMouseOut=\"CambiarFondo('Docente319','borddoc_izq319','borddoc_der319','0','0')\" onClick=\"Opciones_SubMen('../Doc/Inasistencias.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Inasisten Vie</span></div><div id=\"borddoc_der319\" style=\"position:absolute; width:4px; height:15px; z-index:319; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			  $top=$top+15;
			}
             $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq314\" style=\"position:absolute; width:4px; height:15px; z-index:314; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente314\" style=\"position:absolute; z-index:314; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente314','borddoc_izq314','borddoc_der314','1','0')\" onMouseOut=\"CambiarFondo('Docente314','borddoc_izq314','borddoc_der314','0','0')\" onClick=\"Opciones_SubMen('../Doc/Inasistencias_Nueva.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Inasistencias</span></div><div id=\"borddoc_der314\" style=\"position:absolute; width:4px; height:15px; z-index:314; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
          }
        if($banddetins==1){ //Notas
		   if($_SESSION[ci]=='17057572'){
            $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq315\" style=\"position:absolute; width:4px; height:15px; z-index:315; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente315\" style=\"position:absolute; z-index:315; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente315','borddoc_izq315','borddoc_der315','1','0')\" onMouseOut=\"CambiarFondo('Docente315','borddoc_izq315','borddoc_der315','0','0')\" onClick=\"Opciones_SubMen('../Doc/Notas.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Notas Vieja</span></div><div id=\"borddoc_der315\" style=\"position:absolute; width:4px; height:15px; z-index:315; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
			}
           $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq317\" style=\"position:absolute; width:4px; height:15px; z-index:317; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente317\" style=\"position:absolute; z-index:317; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente317','borddoc_izq317','borddoc_der317','1','0')\" onMouseOut=\"CambiarFondo('Docente317','borddoc_izq317','borddoc_der317','0','0')\" onClick=\"Opciones_SubMen('../Doc/Notas_Nueva.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Notas</span></div><div id=\"borddoc_der317\" style=\"position:absolute; width:4px; height:15px; z-index:317; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
          }
...
/*			if($_SESSION[ci]=='17057572' || $_SESSION[ci]=='15438027' || $_SESSION[ci]=='9229437'){		*/	
            $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"borddoc_izq318\" style=\"position:absolute; width:4px; height:15px; z-index:318; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Docente318\" style=\"position:absolute; z-index:318; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Docente318','borddoc_izq318','borddoc_der318','1','0')\" onMouseOut=\"CambiarFondo('Docente318','borddoc_izq318','borddoc_der318','0','0')\" onClick=\"Opciones_SubMen('../Doc/Porcentaje_nuevo.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">% de Evaluaci&oacute;n</span></div><div id=\"borddoc_der318\" style=\"position:absolute; width:4px; height:15px; z-index:318; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
/*			}*/
          }
		$this->resultado=$this->resultado."</table>
...
//******************************************************************
  function menu_coordinador(){
    ...
    $bandact=0;	
	$bandhorario_nuevo=$top=$bandasigsec=$bandofernuev=$bandreportes=0;
	$idper=$_SESSION[idper];
	$ci=$_SESSION[ci];
    $res=$this->OperacionCualquiera("SELECT * FROM tab_ope WHERE per_id='$idper' AND tab_ope_sta='1'");
	while($array=$this->ConsultarCualquiera($res)){
		  ...
		  if($array->tab_id=='41' && ($idper=='1') && ($array->ope_id=='1'|| $array->ope_id=='2' ||$array->ope_id=='3' || $array->ope_id=='4' || $array->ope_id=='5' || $array->ope_id=='6')) $bandofer=1;
		  if($array->tab_id=='36' && ($idper=='1' || $idper=='2' || $idper=='6') && ($array->ope_id=='2' || $array->ope_id=='5' || $array->ope_id=='6' || $array->ope_id=='7')){ $bandlista=1; $bandreportes=1;}
		  ...
		  if($array->tab_id=='27' && ($idper=='1' || $idper=='2') && ($array->ope_id=='2' || $array->ope_id=='5' || $array->ope_id=='6' || $array->ope_id=='7')) $banddocente=1;
	  	  if($array->tab_id=='69' && ($idper=='1') && ($array->ope_id=='1'|| $array->ope_id=='2' ||$array->ope_id=='3' || $array->ope_id=='4' || $array->ope_id=='5' || $array->ope_id=='6')) $bandhorario=1;
    ...
    $this->resultado="
      ...
      <td width=\"118px\" height=\"25px\"><div id=\"Layer4\" style=\"position:absolute; width:118px; height:20px; z-index:4; top: 0px; left:".$Centro."px;\" class=\"div1Dentro\" onMouseOver=\"CambiarFondo('Layer4','Layer41','Layer42','1','1')\" onMouseOut=\"CambiarFondo('Layer4','Layer41','Layer42','0','1')\" onClick=\"MostrarOcultar_SubMen('Layer43','1','imagCoordinador')\">
	    ...
	    if($bandracad==1)//Record Academico
		{
			...
			$top=$top+15;
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordcord_izq4113\" style=\"position:absolute; width:4px; height:15px; z-index:4113; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Coordinador4113\" style=\"position:absolute; z-index:4113; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Coordinador4113','bordcord_izq4113','bordcord_der4113','1','0')\" onMouseOut=\"CambiarFondo('Coordinador4113','bordcord_izq4113','bordcord_der4113','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/Ret_Inc_Cam_Admin.php','SinData','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Cambio de Secci&oacute;n</span></div><div id=\"bordcord_der4113\" style=\"position:absolute; width:4px; height:15px; z-index:4113; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;		
		}
		if($bandreportes==1){ //REPORTES
            $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordcord_izq4114\" style=\"position:absolute; width:4px; height:15px; z-index:4114; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Coordinador4114\" style=\"position:absolute; z-index:4114; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Coordinador4114','bordcord_izq4114','bordcord_der4114','1','0')\" onMouseOut=\"CambiarFondo('Coordinador4114','bordcord_izq4114','bordcord_der4114','0','0')\" onClick=\"Opciones_SubMen('../Coord/Reportes.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Reportes</span></div><div id=\"bordcord_der4114\" style=\"position:absolute; width:4px; height:15px; z-index:4114; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
        }
	    if($bandsec==1 && ($_SESSION[ci]=='17057572' || $_SESSION[ci]=='18419247')) //SECCION
		{
		...
		if($_SESSION[ci]=='15927437'){
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5126\" style=\"position:absolute; width:4px; height:15px; z-index:5126; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5126\" style=\"position:absolute; z-index:5126; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5126','bordsecr_izq5126','bordsecr_der5126','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5126','bordsecr_izq5126','bordsecr_der5126','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/Ret_Inc_Cam_Admin_Todos.php','SinData','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Ret-Inc-Camb-PA-Ant</span></div><div id=\"bordsecr_der5126\" style=\"position:absolute; width:4px; height:15px; z-index:5126; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
			}
		$this->resultado=$this->resultado."</table>
        </div>
...
//******************************************************************
  function menu_secretaria(){
    ...
    $Bord_rigt=$Centro+108;
	$bandact=0;
	$top=$bandpens=$bandinscr=$bandconstculm=$bandnotacert=$bandlisgraduan=$bandgeneactas=0;
	$bandpens='0';
	$idper=$_SESSION[idper];
    $res=$this->OperacionCualquiera("SELECT * FROM tab_ope WHERE per_id='$idper' AND tab_ope_sta='1'");
	while($array=$this->ConsultarCualquiera($res)){
		  ...
		  if($array->tab_id=='29' && ($idper=='1' || $idper=='5' || $idper=='8') &&  ($array->ope_id=='1' || $array->ope_id=='2' ||$array->ope_id=='3' || $array->ope_id=='4' || $array->ope_id=='5' || $array->ope_id=='6')){ $bandsolici=1; $bandnotas=1; $bandgeneactas=1;}
		  ...
		  if($array->tab_id=='36' && ($idper=='1' || $idper=='5' || $idper=='7' || $idper=='8' || $idper=='9' || $idper=='10') &&  ($array->ope_id=='6' || $array->ope_id=='7')){ $bandconstestu=1; $bandconstinsc=1; $bandrecordacad=1; $bandconstcali=1; $bandconstculm='1'; $bandnotacert='1'; $bandreportes='1';}
		  if($array->tab_id=='36' && ($idper=='1' || $idper=='5' || $idper=='8') &&  ($array->ope_id=='6' || $array->ope_id=='7')){ $bandlisgraduan='1';}
		  ...
		  if($array->tab_id=='26' && ($idper=='1' || $idper=='5' || $idper=='8' || $idper=='10') &&  ($array->ope_id=='6' || $array->ope_id=='7')){ $bandexped=1;}
   }
    ...
    $this->resultado="
      ...
      <td width=\"108px\" height=\"25px\"><div id=\"Layer5\" style=\"position:absolute; width:108px; height:20px; z-index:5; top: 0px; left:".$Centro."px;\" class=\"div1Dentro\" onMouseOver=\"CambiarFondo('Layer5','Layer51','Layer52','1','1')\" onMouseOut=\"CambiarFondo('Layer5','Layer51','Layer52','0','1')\" onClick=\"MostrarOcultar_SubMen('Layer53','1','imagSecretaria')\">
		...
		{ 
			...
			$top=$top+15;
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5125\" style=\"position:absolute; width:4px; height:15px; z-index:5125; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5125\" style=\"position:absolute; z-index:5125; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5125','bordsecr_izq5125','bordsecr_der5125','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5125','bordsecr_izq5125','bordsecr_der5125','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/ConstCulmin_Serv_Comu.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Culmina Serv. Comu.</span></div><div id=\"bordsecr_der5125\" style=\"position:absolute; width:4px; height:15px; z-index:5125; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
		...
		if($bandgeneactas==1)//GENERAR ACTAS DE NOTAS
		{
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5126\" style=\"position:absolute; width:4px; height:15px; z-index:5126; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5126\" style=\"position:absolute; z-index:5126; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5126','bordsecr_izq5126','bordsecr_der5126','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5126','bordsecr_izq5126','bordsecr_der5126','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/GenerarActas.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Generar Actas</span></div><div id=\"bordsecr_der5126\" style=\"position:absolute; width:4px; height:15px; z-index:5126; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}		
		...
		if($bandnotacert==1)//Nota Certificada 
		{
			...
			$top=$top+15;
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5129\" style=\"position:absolute; width:4px; height:15px; z-index:5129; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5129\" style=\"position:absolute; z-index:5129; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5129','bordsecr_izq5129','bordsecr_der5129','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5129','bordsecr_izq5129','bordsecr_der5129','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/NotasCertificadas_Matricula.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Notas X Matricula</span></div><div id=\"bordsecr_der5129\" style=\"position:absolute; width:4px; height:15px; z-index:5129; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
		...
		{
			if($idper=='1' && ($_SESSION[ci]=='17057572' || $_SESSION[ci]=='18419247' || $_SESSION[ci]=='9229437')){
			...
			$top=$top+15;
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5128\" style=\"position:absolute; width:4px; height:15px; z-index:5128; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5128\" style=\"position:absolute; z-index:5128; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5128','bordsecr_izq5128','bordsecr_der5128','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5128','bordsecr_izq5128','bordsecr_der5128','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/Ret_Inc_Cam_Admin_Todos.php','SinData','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Ret-Inc-Camb-PA-Ant</span></div><div id=\"bordsecr_der5128\" style=\"position:absolute; width:4px; height:15px; z-index:5128; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
			}
			$this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5124\" style=\"position:absolute; width:4px; height:15px; z-index:5124; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5124\" style=\"position:absolute; z-index:5124; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5124','bordsecr_izq5124','bordsecr_der5124','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5124','bordsecr_izq5124','bordsecr_der5124','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/Ret_Inc_Cam_Admin.php','SinData','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Ret.-Inc.-Camb.-PA-Act</span></div><div id=\"bordsecr_der5124\" style=\"position:absolute; width:4px; height:15px; z-index:5124; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
	    if($bandrecordacad==1)//Record Academico
		{
			...
			$top=$top+15;
            $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordsecr_izq5112\" style=\"position:absolute; width:4px; height:15px; z-index:5127; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Secretaria5127\" style=\"position:absolute; z-index:5127; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Secretaria5127','bordsecr_izq5127','bordsecr_der5127','1','0')\" onMouseOut=\"CambiarFondo('Secretaria5127','bordsecr_izq5127','bordsecr_der5127','0','0')\" onClick=\"Opciones_SubMen('../Secretaria/RecordAcademico_Matric.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Record X Matricula</span></div><div id=\"bordsecr_der5127\" style=\"position:absolute; width:4px; height:15px; z-index:5127; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
		}
		if($bandreportes==1){ //REPORTES 
    ...
    $this->resultado="
      ...
      <td width=\"140px\" height=\"25px\"><div id=\"Layer7\" style=\"position:absolute; width:140px; height:20px; z-index:7; top: 0px; left:".$Centro."px;\" class=\"div1Dentro\" onMouseOver=\"CambiarFondo('Layer7','Layer71','Layer72','1','1')\" onMouseOut=\"CambiarFondo('Layer7','Layer71','Layer72','0','1')\" onClick=\"MostrarOcultar_SubMen('Layer73','1','imagconfiguracion')\">
        ...
        <div id=\"Layer73\" style=\"position:absolute; width:150px; height:200px; z-index:73; border: 1px none #000000; visibility: hidden;\" onMouseMove=\"MostrarOcultar_SubMen('Layer73','1','imagconfiguracion')\" onMouseOut=\"MostrarOcultar_SubMen('Layer73','0','imagconfiguracion')\">
          <table width=\"150px\" height=\"200px\"  border=\"0\" cellspacing=\"0\" cellpadding=\"0\">";
		if($_SESSION[ci]=='17057572'){ //CONSULTA POR BD
           $this->resultado=$this->resultado."<tr><td width=\"150px\" height=\"15px\"><div id=\"bordconf_izq7136\" style=\"position:absolute; width:4px; height:15px; z-index:7136; top: ".$top."px;\" class=\"divDentroBorder_Izq\"></div><div id=\"Configuracion7136\" style=\"position:absolute; z-index:7136; border: 1px none #000000; top: ".$top."px; width: 142px; height: 15px; left: 4px;\" align=\"left\" class=\"div2Dentro\" onMouseOver=\"CambiarFondo('Configuracion7136','bordconf_izq7136','bordconf_der7136','1','0')\" onMouseOut=\"CambiarFondo('Configuracion7136','bordconf_izq7136','bordconf_der7136','0','0')\" onClick=\"Opciones_SubMen('../Configuracion/consultar_BD.php','Listar','42')\"><img src=\"../Imagenes/small-green-glasy-bullet.gif\">&nbsp;<span class=\"Estilo11\">Consulta de Datos</span></div><div id=\"bordconf_der7136\" style=\"position:absolute; width:4px; height:15px; z-index:7136; top: ".$top."px; left: 146px;\" class=\"divDentroBorder_Der\"></div></td></tr>";
			$top=$top+15;
        }
		if($bandact==1){ //ACTUALIZACIÓN
...
/*		  echo "<script>alert('ENTRE MANTENIMIENTO $banderaC $array->tab_id, $array->ope_id');</script>";*/
	...
	if(($banderaS==1 && ($idper=='1' || $idper=='5' || $idper=='8')) || $idper=='7' || $idper=='9' || $idper=='10')
