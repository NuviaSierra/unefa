...
//******************************************************************
  function Listado_horario_Nucleo_Infrae_asignatura($nuc_id,$inf_id,$inicial,$cantidad,$asi_cod){
    $resultado=$this->Operacion("SELECT DISTINCT(A.asi_cod) AS 'asi_cod', A.asi_nom AS 'asi_nom', A.asi_cba AS 'asi_cba', B.inf_id AS 'inf_id', B.inf_nom AS 'inf_nom', C.nuc_id AS 'nuc_id', C.nuc_nom AS 'nuc_nom' FROM asigna A, infrae B, nucleo C, seccio D, asigna_seccio E WHERE C.nuc_id='$nuc_id' AND B.inf_id='$inf_id' AND A.asi_cod=E.asi_cod AND A.asi_cod='$asi_cod' AND E.sec_id=D.sec_id AND B.inf_id=D.inf_id AND B.nuc_id=C.nuc_id AND E.pac_id='$this->pac_id' AND E.ase_sta='1' AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = '0000-00-00 00:00:00' AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = '1' AND C.rem_sta = '1' AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = '1' AND D.matr_sta = '1' AND D.ci = '$this->ci') AND A.asi_cod IN (SELECT DISTINCT(A.asi_cod) FROM asigna_seccio A, matric B WHERE A.esp_id=B.esp_id AND A.reg_id=B.reg_id AND A.mod_id=B.mod_id AND A.coh_id=B.coh_id AND A.pen_top=B.pen_top AND B.matr_tip='1' AND B.matr_sta='1' AND B.ci='$this->ci' AND A.pac_id='$this->pac_id') ORDER BY nuc_nom,inf_nom,asi_nom,asi_cod LIMIT $cantidad OFFSET $inicial");
    return $resultado;
  }
//******************************************************************
...
//******************************************************************
  function Contar_horario_Nucleo_Todas_asignatura($nuc_id,$asi_cod){
    $num_filas='';
    //$this->ci=$_SESSION['nacid'];
    $this->Operacion("SELECT DISTINCT(A.asi_cod) AS 'asi_cod', A.asi_nom AS 'asi_nom', A.asi_cba AS 'asi_cba', B.inf_id AS 'inf_id', B.inf_nom AS 'inf_nom', C.nuc_id AS 'nuc_id', C.nuc_nom AS 'nuc_nom' FROM asigna A, infrae B, nucleo C, seccio D, asigna_seccio E WHERE C.nuc_id='$nuc_id' AND  A.asi_cod=E.asi_cod AND A.asi_cod='$asi_cod' AND E.sec_id=D.sec_id AND B.inf_id=D.inf_id AND B.nuc_id=C.nuc_id AND E.pac_id='$this->pac_id' AND E.ase_sta='1' AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = '0000-00-00 00:00:00' AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = '1' AND C.rem_sta = '1' AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = '1' AND D.matr_sta = '1' AND D.ci = '$this->ci') AND A.asi_cod IN (SELECT DISTINCT(A.asi_cod) FROM asigna_seccio A, matric B WHERE A.esp_id=B.esp_id AND A.reg_id=B.reg_id AND A.mod_id=B.mod_id AND A.coh_id=B.coh_id AND A.pen_top=B.pen_top AND B.matr_tip='1' AND B.matr_sta='1' AND B.ci='$this->ci' AND A.pac_id='$this->pac_id')");
    $num_filas=$this->NumFilas();
    return $num_filas;
  }
//******************************************************************
  function Listado_horario_Nucleo_Todas_asignatura($nuc_id,$inicial,$cantidad,$asi_cod){
    $resultado=$this->Operacion("SELECT DISTINCT(A.asi_cod) AS 'asi_cod', A.asi_nom AS 'asi_nom', A.asi_cba AS 'asi_cba', B.inf_id AS 'inf_id', B.inf_nom AS 'inf_nom', C.nuc_id AS 'nuc_id', C.nuc_nom AS 'nuc_nom' FROM asigna A, infrae B, nucleo C, seccio D, asigna_seccio E WHERE C.nuc_id='$nuc_id' AND A.asi_cod=E.asi_cod AND A.asi_cod='$asi_cod' AND E.sec_id=D.sec_id AND B.inf_id=D.inf_id AND B.nuc_id=C.nuc_id AND E.pac_id='$this->pac_id' AND E.ase_sta='1' AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = '0000-00-00 00:00:00' AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = '1' AND C.rem_sta = '1' AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = '1' AND D.matr_sta = '1' AND D.ci = '$this->ci') AND A.asi_cod IN (SELECT DISTINCT(A.asi_cod) FROM asigna_seccio A, matric B WHERE A.esp_id=B.esp_id AND A.reg_id=B.reg_id AND A.mod_id=B.mod_id AND A.coh_id=B.coh_id AND A.pen_top=B.pen_top AND B.matr_tip='1' AND B.matr_sta='1' AND B.ci='$this->ci' AND A.pac_id='$this->pac_id') ORDER BY nuc_nom,inf_nom,asi_nom,asi_cod LIMIT $cantidad OFFSET $inicial");
    return $resultado;
  }
//******************************************************************
...
//******************************************************************
  function Listado_Nucleo(){
    $resultado=$this->Operacion("SELECT DISTINCT (A.nuc_id) AS 'nuc_id', A.nuc_nom AS 'nuc_nom' FROM nucleo A, infrae B WHERE A.nuc_sta = '1' AND A.nuc_id = B.nuc_id AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = '0000-00-00 00:00:00' AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = '1' AND C.rem_sta = '1' AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = '1' AND D.matr_sta = '1' AND D.ci = '$this->ci') order by A.nuc_nom");
    return $resultado;
  }
//******************************************************************
  function Contar_horario_Todas_asignatura($cod_asi){
    $num_filas='';
    //$this->ci=$_SESSION['nacid'];
    $this->Operacion("SELECT DISTINCT(A.asi_cod) AS 'asi_cod', A.asi_nom AS 'asi_nom', A.asi_cba AS 'asi_cba', B.inf_id AS 'inf_id', B.inf_nom AS 'inf_nom', C.nuc_id AS 'nuc_id', C.nuc_nom AS 'nuc_nom' FROM asigna A, infrae B, nucleo C, seccio D, asigna_seccio E WHERE A.asi_cod=E.asi_cod AND A.asi_cod='$cod_asi' AND E.sec_id=D.sec_id AND D.inf_id=B.inf_id AND B.nuc_id=C.nuc_id AND E.pac_id='$this->pac_id' AND E.ase_sta='1' AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = '0000-00-00 00:00:00' AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = '1' AND C.rem_sta = '1' AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = '1' AND D.matr_sta = '1' AND D.ci = '$this->ci') AND A.asi_cod IN (SELECT DISTINCT(A.asi_cod) FROM asigna_seccio A, matric B WHERE A.esp_id=B.esp_id AND A.reg_id=B.reg_id AND A.mod_id=B.mod_id AND A.coh_id=B.coh_id AND A.pen_top=B.pen_top AND B.matr_tip='1' AND B.matr_sta='1' AND B.ci='$this->ci' AND A.pac_id='$this->pac_id')");
    $num_filas=$this->NumFilas();
    return $num_filas;
  }
//******************************************************************
...
//******************************************************************
  function Listado_horario_Todas_asignatura($inicial,$cantidad,$cod_asi){
/*  echo "<script>alert('SELECT DISTINCT(A.asi_cod) AS asi_cod, A.asi_nom AS asi_nom, A.asi_cba AS asi_cba, B.inf_id AS inf_id, B.inf_nom AS inf_nom, C.nuc_id AS nuc_id, C.nuc_nom AS nuc_nom FROM asigna A, infrae B, nucleo C, seccio D, asigna_seccio E WHERE A.asi_cod=E.asi_cod AND E.sec_id=D.sec_id AND B.inf_id=D.inf_id AND B.nuc_id=C.nuc_id AND E.pac_id=$this->pac_id AND E.ase_sta=1 AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = 0000-00-00 00:00:00 AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = 1 AND C.rem_sta = 1 AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = 1 AND D.matr_sta = 1 AND D.ci = $this->ci) AND A.asi_cod IN (SELECT DISTINCT(A.asi_cod) FROM asigna_seccio A, matric B WHERE A.esp_id=B.esp_id AND A.reg_id=B.reg_id AND A.mod_id=B.mod_id AND A.coh_id=B.coh_id AND A.pen_top=B.pen_top AND B.matr_tip=1 AND B.matr_sta=1 AND B.ci=$this->ci AND A.pac_id=$this->pac_id) ORDER BY nuc_nom,inf_nom,asi_nom,asi_cod LIMIT $cantidad OFFSET $inicial');</script>";*/
    $resultado=$this->Operacion("SELECT DISTINCT(A.asi_cod) AS 'asi_cod', A.asi_nom AS 'asi_nom', A.asi_cba AS 'asi_cba', B.inf_id AS 'inf_id', B.inf_nom AS 'inf_nom', C.nuc_id AS 'nuc_id', C.nuc_nom AS 'nuc_nom' FROM asigna A, infrae B, nucleo C, seccio D, asigna_seccio E WHERE A.asi_cod=E.asi_cod AND A.asi_cod='$cod_asi' AND E.sec_id=D.sec_id AND B.inf_id=D.inf_id AND B.nuc_id=C.nuc_id AND E.pac_id='$this->pac_id' AND E.ase_sta='1' AND B.inf_id IN (SELECT DISTINCT(A.inf_id) FROM estudi_infrae A, reg_esp_mod_infrae B, reg_esp_mod C, matric D WHERE A.inf_id = B.inf_id AND A.est_inf_ffi = '0000-00-00 00:00:00' AND B.mod_id = C.mod_id AND B.esp_id = C.esp_id AND B.reg_id = C.reg_id AND B.remi_sta = '1' AND C.rem_sta = '1' AND D.mod_id = C.mod_id AND D.esp_id = C.esp_id AND D.reg_id = C.reg_id AND D.matr_tip = '1' AND D.matr_sta = '1' AND D.ci = '$this->ci') AND A.asi_cod IN (SELECT DISTINCT(A.asi_cod) FROM asigna_seccio A, matric B WHERE A.esp_id=B.esp_id AND A.reg_id=B.reg_id AND A.mod_id=B.mod_id AND A.coh_id=B.coh_id AND A.pen_top=B.pen_top AND B.matr_tip='1' AND B.matr_sta='1' AND B.ci='$this->ci' AND A.pac_id='$this->pac_id') ORDER BY nuc_nom,inf_nom,asi_nom,asi_cod LIMIT $cantidad OFFSET $inicial");
    return $resultado;
  }
//******************************************************************
