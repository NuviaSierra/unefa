...
//******************************************************************
  function Listado_asigna($mod_id, $reg_id, $esp_id, $coh_id, $pen_top){
    $resultado=$this->OperacionCualquiera("SELECT * FROM asigna WHERE coh_id='$coh_id' AND mod_id='$mod_id' AND esp_id='$esp_id' AND reg_id='$reg_id' AND pen_top='$pen_top' order by asi_mod");
    return $resultado;
  }
//******************************************************************
  function Listado_asigna2($mod_id, $reg_id, $esp_id, $coh_id, $pen_top, $st, $asi_cod){
/*  echo "<script>alert('SELECT * FROM asigna WHERE coh_id=$coh_id AND mod_id=$mod_id AND esp_id=$esp_id AND reg_id=$reg_id AND pen_top=$pen_top AND asi_mod<=$st order by asi_mod');</script>";  */
    $resultado=$this->OperacionCualquiera("SELECT * FROM asigna WHERE coh_id='$coh_id' AND mod_id='$mod_id' AND esp_id='$esp_id' AND reg_id='$reg_id' AND pen_top='$pen_top' AND asi_mod<='$st' AND asi_cod!='$asi_cod' order by asi_mod");
    return $resultado;
  }
//******************************************************************
...
/*  echo "<script>alert('SELECT * FROM requis WHERE coh_id=$coh_id AND mod_id=$mod_id AND esp_id=$esp_id AND reg_id=$reg_id AND pen_top=$pen_top AND asi_cod=$asi_cod order by asi_cod_req');</script>";*/
    $resultado=$this->OperacionCualquiera("SELECT * FROM requis WHERE coh_id='$coh_id' AND mod_id='$mod_id' AND esp_id='$esp_id' AND reg_id='$reg_id' AND pen_top='$pen_top' AND asi_cod='$asi_cod' order by asi_cod_req");
    return $resultado;
  }
//******************************************************************
...
//******************************************************************
  function Eliminar_pensum(){
    ...
    $num_filas=$this->filas_afectadas($res);	
	if($num_filas>0){
	  $this->Listado_asigna($this->mod_id,$this->reg_id,$this->esp_id,$this->coh_id,$this->pen_top);
	  while($array=$this->Consultar()){
		$num_filas=$this->Eliminar_asigna($array->asi_cod);
  	    $accion='ELIMINAR';
	    $Operacion="MOD: ".$this->mod_id." REG: ".$this->reg_id." ESP: ".$this->esp_id." COH: ".$this->coh_id." TI_PE".$this->pen_top." ASIG: ".$asi_co[$i];	
	    $this->guardar_accion($accion,"asigna",$Operacion);
	  }
